...
When printing text strings, the interpretation of characters in indicator segments is used. Instead of unsupported characters (e.g. **K, M, N, V, W, X, Z**) an `top underline` is displayed (segment **a**).
